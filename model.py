...
def unet_data_consistency(x, NUM_OUTPUTS = 2):
    print('Unet data consistency: Output ', NUM_OUTPUTS);
    ...
    prediction = tf.layers.conv2d(conv9, NUM_OUTPUTS, [1, 1], padding="SAME", activation=None, kernel_initializer=he_init, name='Output')
    consistency = tf.layers.conv2d(conv9, NUM_OUTPUTS, [1, 1], padding="SAME", activation=None, kernel_initializer=he_init, name='Consistency')
